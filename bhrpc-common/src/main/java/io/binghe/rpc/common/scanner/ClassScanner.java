    ...
    public static List<String> getClassNameList(String packageName) throws Exception {
        ...
        while (dirs.hasMoreElements()) {
            ...
            if (PROTOCOL_FILE.equals(protocol)) {
                ...
                findAndAddClassesInPackageByFile(packageName, filePath, true, classNameList);
            } else if (PROTOCOL_JAR.equals(protocol)) {
                //TODO
                packageName = findAndAddClassesInPackageByJar(packageName, classNameList, true, packageDirName, url);
            }
        }
